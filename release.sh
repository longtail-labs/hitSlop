#!/bin/bash
# Local build and release script for hitSlop
...
if [ ! -f "conveyor.conf" ] || [ ! -d "hitSlop" ]; then
    print_error "Error: This script must be run from the hitslop root directory"
    exit 1
fi
...
echo ""
print_info "======================================"
print_info "    hitSlop Local Release Builder     "
print_info "======================================"
echo ""
...
# Step 4: Copy built app to expected location
print_info "\n📦 Preparing app bundle..."
mkdir -p build/Build/Products/Release

if [ -d "hitSlop/build/Build/Products/Release/hitSlop.app" ]; then
    cp -R "hitSlop/build/Build/Products/Release/hitSlop.app" "build/Build/Products/Release/"
...
print_info "\n📋 App bundle contents:"
ls -la build/Build/Products/Release/hitSlop.app/Contents/
